...
class FloweringPlant(Plant):
    ...
    def total_height(self):
        print(f"- {self.name} : {self.height}cm " f"{self.flower_color} (blooming)")
...
class PrizeFlower(FloweringPlant):
    ...
    def total_height(self):
        print(
            f"- {self.name} : {self.height}cm {self.flower_color}"
...
class GardenManager:
    ...
    def get_infos(self, g_name: str):
        if g_name in self.gardens:
            ...
            print(f"\nPlants added : {t_plants}," f" total growth : {t_growth}")
...
def main():
    ...
    print(
        f"Garden scores - Alice: {manager.get_garden_score('Alice')},"
